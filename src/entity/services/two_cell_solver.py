"""Solve a partial 4×4 magic square with exactly two empty cells."""
...
def solve_two_cell_magic_square(grid: list[list[int]]) -> list[int]:
    """Solve using Step A then Step B placement (row-major blanks, 1-index output).
